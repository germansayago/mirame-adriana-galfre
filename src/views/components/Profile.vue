    ...
    <section class="section bg-secondary">
      <div class="container">
          <div class="row row-grid align-items-center">
              ...
              <div class="col-md-7">
                  <div class="pl-md-5">
                      <h3>Adriana Miriam Galfré</h3>
                      <p class="lead">Nació en la ciudad de Rio Cuarto (Córdoba, Argentina).</p>
                      <p>Es Fisioterapeuta egresada de la Universidad Nacional de Córdoba y desde 1985 ejerce la profesión, dedicada especialmente a personas con trastornos neuromotores.</p>
